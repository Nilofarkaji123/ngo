...
const Home = () => {
  ...
  const donations = [
    ...
    },
    {
      icon: <FaBookOpen />,
      title: "Book Donation",
      desc: "Donate books by category: Story, Academic, or Reference to empower children.",
    ...
    },
    {
      ...
      desc: "Provide financial support for NGO projects, school supplies, and family aid.",
    ...
    },
    {
      ...
      route: "/medical-support", // ✅ fixed route
    },
    {
      icon: <FaBirthdayCake />,
    ...
    <div className="home-container">
      ...
      >
        ...
        <p>
          ...
          supporting children. Our mission is to create a world where every
          child has access to education, nutrition, and care.
        </p>
      </section>
